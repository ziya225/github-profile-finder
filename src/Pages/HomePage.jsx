...
const HomePage = () => {
  ...
  return (
    <>
      ...
      <form form className="my-5 form-control">
          ...
          userSearch.map((user) => {
            return (
              <div key={user.id} className="mx-auto mb-5">
                <div className="flex pt-5 border-white card card-bordered bg-slate-800 w-72 ">
                  ...
                  <div className="flex items-center card-body">
                    <h1 className="text-2xl card-title">{user.login}</h1>
